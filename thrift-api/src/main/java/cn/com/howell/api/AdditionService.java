...
public class AdditionService {
  ...
  public interface Iface {
    ...
    public cn.com.howell.api.resp.Addresp tre(cn.com.howell.api.req.Addreq s1) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void tre(cn.com.howell.api.req.Addreq s1, org.apache.thrift.async.AsyncMethodCallback<cn.com.howell.api.resp.Addresp> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_getString(java.lang.String s1) throws org.apache.thrift.TException
    {
    ...
    public java.lang.String recv_getString() throws org.apache.thrift.TException
    {
    ...
    public cn.com.howell.api.resp.Addresp recv_tre() throws org.apache.thrift.TException
    {
      ...
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "tre failed: unknown result");
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void getString(java.lang.String s1, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      getString_call method_call = new getString_call(s1, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class getString_call extends org.apache.thrift.async.TAsyncMethodCall<java.lang.String> {
      private java.lang.String s1;
      public getString_call(java.lang.String s1, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.s1 = s1;
      }
    ...
    public static class tre_call extends org.apache.thrift.async.TAsyncMethodCall<cn.com.howell.api.resp.Addresp> {
      private cn.com.howell.api.req.Addreq s1;
      public tre_call(cn.com.howell.api.req.Addreq s1, org.apache.thrift.async.AsyncMethodCallback<cn.com.howell.api.resp.Addresp> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.s1 = s1;
      }
      ...
      public cn.com.howell.api.resp.Addresp getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new java.lang.IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_tre();
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class getString<I extends Iface> extends org.apache.thrift.ProcessFunction<I, getString_args> {
      ...
      public getString_result getResult(I iface, getString_args args) throws org.apache.thrift.TException {
        getString_result result = new getString_result();
        result.success = iface.getString(args.s1);
        return result;
      }
    }

    public static class tre<I extends Iface> extends org.apache.thrift.ProcessFunction<I, tre_args> {
      public tre() {
        super("tre");
      }

      public tre_args getEmptyArgsInstance() {
        return new tre_args();
      }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getString<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getString_args, java.lang.String> {
      public getString() {
        super("getString");
      }
      ...
      public void start(I iface, getString_args args, org.apache.thrift.async.AsyncMethodCallback<java.lang.String> resultHandler) throws org.apache.thrift.TException {
        iface.getString(args.s1,resultHandler);
      }
    }

    public static class tre<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, tre_args, cn.com.howell.api.resp.Addresp> {
      public tre() {
        super("tre");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<cn.com.howell.api.resp.Addresp> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<cn.com.howell.api.resp.Addresp>() { 
          public void onComplete(cn.com.howell.api.resp.Addresp o) {
            tre_result result = new tre_result();
            result.success = o;
            try {
              fcall.sendResponse(fb, result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, tre_args args, org.apache.thrift.async.AsyncMethodCallback<cn.com.howell.api.resp.Addresp> resultHandler) throws org.apache.thrift.TException {
  ...
  public static class getString_args implements org.apache.thrift.TBase<getString_args, getString_args._Fields>, java.io.Serializable, Cloneable, Comparable<getString_args>   {
    ...
    public getString_args setS1(java.lang.String s1) {
      this.s1 = s1;
      return this;
    }
  ...
  public static class getString_result implements org.apache.thrift.TBase<getString_result, getString_result._Fields>, java.io.Serializable, Cloneable, Comparable<getString_result>   {
    ...
    public getString_result setSuccess(java.lang.String success) {
      this.success = success;
      return this;
    }
  ...
  public static class tre_args implements org.apache.thrift.TBase<tre_args, tre_args._Fields>, java.io.Serializable, Cloneable, Comparable<tre_args>   {
    ...
    public boolean equals(java.lang.Object that) {
      if (that == null)
        return false;
      if (that instanceof tre_args)
        return this.equals((tre_args)that);
      return false;
    }

    public boolean equals(tre_args that) {
      if (that == null)
        return false;
      if (this == that)
        return true;
    ...
    @Override
    public int compareTo(tre_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    private static class tre_argsStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public tre_argsStandardScheme getScheme() {
        return new tre_argsStandardScheme();
      }
    }

    private static class tre_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<tre_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, tre_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, tre_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class tre_argsTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public tre_argsTupleScheme getScheme() {
        return new tre_argsTupleScheme();
      }
    }

    private static class tre_argsTupleScheme extends org.apache.thrift.scheme.TupleScheme<tre_args> {
  ...
  public static class tre_result implements org.apache.thrift.TBase<tre_result, tre_result._Fields>, java.io.Serializable, Cloneable, Comparable<tre_result>   {
    ...
    public cn.com.howell.api.resp.Addresp success; // required
    ...
    static {
      java.util.Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new java.util.EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, cn.com.howell.api.resp.Addresp.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public tre_result(
      cn.com.howell.api.resp.Addresp success)
    {
      this();
      this.success = success;
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public tre_result(tre_result other) {
      if (other.isSetSuccess()) {
        this.success = new cn.com.howell.api.resp.Addresp(other.success);
      }
    }

    public tre_result deepCopy() {
      return new tre_result(this);
    }
    ...
    public cn.com.howell.api.resp.Addresp getSuccess() {
      return this.success;
    }

    public tre_result setSuccess(cn.com.howell.api.resp.Addresp success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, java.lang.Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((cn.com.howell.api.resp.Addresp)value);
        }
        break;
    ...
    public boolean equals(java.lang.Object that) {
      if (that == null)
        return false;
      if (that instanceof tre_result)
        return this.equals((tre_result)that);
      return false;
    }

    public boolean equals(tre_result that) {
      if (that == null)
        return false;
      if (this == that)
        return true;
    ...
    @Override
    public int compareTo(tre_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    @Override
    public java.lang.String toString() {
      java.lang.StringBuilder sb = new java.lang.StringBuilder("tre_result(");
      boolean first = true;
    ...
    private static class tre_resultStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public tre_resultStandardScheme getScheme() {
        return new tre_resultStandardScheme();
      }
    }

    private static class tre_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<tre_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, tre_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new cn.com.howell.api.resp.Addresp();
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, tre_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class tre_resultTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
      public tre_resultTupleScheme getScheme() {
        return new tre_resultTupleScheme();
      }
    }

    private static class tre_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<tre_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, tre_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet optionals = new java.util.BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, tre_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
        java.util.BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = new cn.com.howell.api.resp.Addresp();
